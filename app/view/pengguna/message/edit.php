            ...
            <div class="panel-body container-fluid bg-body-secondary py-3 rounded-2">
                <div class="panel-heading">
                    ...
                    <div class="breadcrumb d-flex justify-content-end align-items-end flex-wrap">
                        ...
                        <li class="breadcrumb breadcrumb-item">
                            <a href="?page=edit-pesan&id=<?= $_GET['id'] ?>" aria-current="page"
                                class="text-decoration-none text-primary">edit pesan</a>
                        </li>
                    </div>
                </div>
                <div class="py-2 zn-1">
                    <div class="card shadow mb-4">
                        <div class="card-header py-2">
                            ...
                            <?php $kepada = $koneksi->query("SELECT * FROM tb_message WHERE id_chat = '$_GET[id]' and toFrom = '$_SESSION[email]'")->fetch_array(); ?>
                            <h4 class="card-title text-center">
                                edit Pesan <br> Kepada <?php echo $kepada['toTo'] ?>
                            </h4>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="col-sm-8 col-md-8">
                                    <div class="card bg-secondary my-1 py-2">
                                        ...
                                        if (isset($_SESSION['email']) && isset($_GET['id'])) {
                                            ...
                                            $SQL = "SELECT * FROM tb_message WHERE id_chat = '$id' and toFrom = '$_SESSION[email]'";
                                            $query = $pesan->editpesan($SQL);
                                            ...
                                            <form action="?aksi=message" enctype="multipart/form-data" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-inline row justify-content-center
                                                        ...
                                                        <div class="col-sm-7 col-md-7">
                                                            <input type="email" value="<?= $toTo ?>" readonly
                                                    ...
                                                    <div class="form-inline row justify-content-center
                                                        ...
                                                        <div class="col-sm-7 col-md-7">
                                                            <input type="text" name="toSubject"
                                                                value="<?= $toSubject ?>" class="form-control"
                                                    ...
                                                    <div class="form-inline row justify-content-center
                                                        ...
                                                        <div class="col-sm-7 col-md-7">
                                                            <textarea name="toMessage" rows="6" class="form-control"
                                                                placeholder="Ketikkan pesan anda disini ..."><?php echo $toMessage ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-inline row justify-content-center
                                                         align-items-center flex-wrap">
                                                        ...
                                                        <div class="col-sm-7 col-md-7">
                                                            <input type="file"
                                                                ...
                                                                name="FileUploadbaru"
                                                                class="form-control-file form-control" id="" multiple>
                                                        </div>
                                                    </div>
                                                </div>
